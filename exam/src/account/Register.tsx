...
const Register = () => {
  return (
    <div className="registrer"> {/* Root container for the registration page */}
      <div className="container-fluid"> {/* Full-width container */}
        <div className="row min-vh-100"> {/* Full viewport height for equal section layout */}
          
          {/* Left Section - Registration Form */}
          <div className="col-md-6 d-flex align-items-center justify-content-center left-section">
            <div className="col-md-8 col-lg-6"> {/* Constraining form width */}
              <h1 className="text-center mb-4">Sign Up</h1> {/* Registration title */}
              <form className="text-center w-100" style={{ maxWidth: '400px' }}> {/* Form container */}
                
                {/* Email Input Field */}
                <div className="form-group position-relative mb-3"> {/* Form group with relative positioning */}
                  <span className="icon position-absolute"> {/* Wrapping the SVG with an icon class */}
                  ...
                  <input
                    ...
                    placeholder="Email"
                    style={{ paddingLeft: '45px' }} // Aligning with icon spacing
                  />
                </div>
